...
$string['addbookmark'] = 'Add to Bookmarks';
$string['removebookmark'] = 'Remove from Bookmarks';
$string['nobookmarks'] = 'No bookmarks saved';
$string['bookmarkhelp'] = 'Bookmark this folder for quick access';
$string['bookmarkadded'] = 'Bookmark added successfully';
$string['bookmarkremoved'] = 'Bookmark removed successfully';
